class LeaguesController < ApplicationController
    ...
    def NFLHome
        ...
        upcomingGames_raw = RestClient.get("http://api.sportradar.us/nfl/official/trial/v5/en/games/2019/PST/1/schedule.json?api_key=gxwenyjwghsgpusdmj8qs8t3")
        upcomingGames = JSON.parse(upcomingGames_raw)
            

        render json: {games: upcomingGames}
