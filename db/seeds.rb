...
User.create(username: 'newuser1', password: 'thegame', email: 'hello', name: "Mike")
User.create(username: 'newuserx', password: 'thegame', email: 'hello', name: "Adam")
User.create(username: 'newuser3', password: 'thegame', email: 'hello', name: "Joseph")
User.create(username: 'newuser4', password: 'thegame', email: 'hello', name: "Sergio")
User.create(username: 'newuser5', password: 'thegame', email: 'hello', name: "Charlie")
User.create(username: 'newuser6', password: 'thegame', email: 'hello', name: "Will")
User.create(username: 'newuser7', password: 'thegame', email: 'hello', name: "Jenny")
User.create(username: 'newuser8', password: 'thegame', email: 'hello', name: "Ann")
User.create(username: 'newuser9', password: 'thegame', email: 'hello', name: "Paul")
User.create(username: 'newuser10', password: 'thegame', email: 'hello', name: "Lucy")
User.create(username: 'newuser11', password: 'thegame', email: 'hello', name: "Mario")
User.create(username: 'newuser12', password: 'thegame', email: 'hello', name: "Rick")
User.create(username: 'newuser13', password: 'thegame', email: 'hello', name: "Christina")
User.create(username: 'newuser14', password: 'thegame', email: 'hello', name: "Graham")
User.create(username: 'newuser15', password: 'thegame', email: 'hello', name: "Mickey")
User.create(username: 'newuser16', password: 'thegame', email: 'hello', name: "Kailey")
User.create(username: 'newuser17', password: 'thegame', email: 'hello', name: "David")
User.create(username: 'newuser18', password: 'thegame', email: 'hello', name: "Nicholas")
User.create(username: 'newuser19', password: 'thegame', email: 'hello', name: "Nick")
User.create(username: 'newuser20', password: 'thegame', email: 'hello', name: "Thomas")
User.create(username: 'newuser21', password: 'thegame', email: 'hello', name: "Allen")
User.create(username: 'newuser22', password: 'thegame', email: 'hello', name: "Danny")
User.create(username: 'newuser23', password: 'thegame', email: 'hello', name: "Derrick")
User.create(username: 'newuser24', password: 'thegame', email: 'hello', name: "Greg")